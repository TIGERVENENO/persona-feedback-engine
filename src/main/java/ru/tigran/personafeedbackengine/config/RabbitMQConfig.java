...
public class RabbitMQConfig {
    ...
    /**
     * Настройка JSON сериализации для RabbitMQ сообщений.
     * Использует Jackson для сериализации/десериализации вместо Java сериализации.
     * Это более безопасно и не требует добавления классов в whitelist.
     *
     * @param objectMapper ObjectMapper для JSON конвертации
     * @return MessageConverter для RabbitMQ
     */
    @Bean
