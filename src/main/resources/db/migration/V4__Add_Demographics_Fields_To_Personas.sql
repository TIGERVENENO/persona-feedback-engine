...
ADD COLUMN demographic_gender VARCHAR(10),
...
-- Add comments
COMMENT ON COLUMN personas.demographic_gender IS 'Gender: male, female, other';
...
CREATE INDEX idx_persona_demographics ON personas(demographic_gender, age, region, income_level) WHERE deleted = false;
